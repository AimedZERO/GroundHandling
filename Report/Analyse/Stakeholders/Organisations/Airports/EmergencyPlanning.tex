...
In conclusion, a runaway can be assigned to "full emergency" or "local standby" statuses, and when an accident occurs, the affected area is closed and traffic through the area is minimized. Furthermore, a signal of NOTAM is issued to notify that airport rescue and fire fighting services are all currently occupied. But it is the airports employees that handles the situation with a couple other organisations such as fire-fighters and rescue, not the ground handling organisations.